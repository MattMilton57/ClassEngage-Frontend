...
const  EditClassContainer = ({ allRegistrations, assessments, classes, classObject, deRegister, deleteStudent, patchClassPeriod, reFetchStudentBody, register, registrations, roster,studentBody, user}) => {
  ...
  return(
    <div className="edit-class">
      ...
      <div className="edit-class__message-center">
        {/* {messageCenter()} */}
        <div className="edit-class__message-center-add">
          <div className="edit-class__message-center-text">
            Click on a student to add them to this class. 
          </div>
        </div>
        <div className="edit-class__message-center-remove">
          <div className="edit-class__message-center-text">
            Click on a registered student to remove them from this class. 
          </div>
        </div>
      </div>
