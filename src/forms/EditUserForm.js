    ...
    render(){
        return(
            <div className="edit-user-form">
                <form  className="edit-user-form__content--form" onSubmit={(e)=> this.onSubmit(e)}>
                    <div className="edit-user-form__content--form-existing-name">
                        Edit User
                    </div>
                    <input 
                        type="text" 
                        id="new_user-form__content--form-name"
                        className="edit-user-form__content--form-name" 
                        placeholder="Edit Username"
                        value={this.state.name}
                        onChange={(e) => this.onChange("name", e.target.value)}/>
                    <button onClick={(e)=> this.onSubmit(e)} className="edit-user-form__content--form-submit" >
                        <span className="edit-user-form__content--form-submit-test">Submit</span>
                    </button>
                </form>
            </div>
        ) 
